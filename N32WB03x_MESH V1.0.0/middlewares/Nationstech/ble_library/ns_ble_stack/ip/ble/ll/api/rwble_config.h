...
/* --------------------------   FEATURE SETUP       --------------------------------------*/
/******************************************************************************************/
#define BLE_FEATURES_BYTE0_AMBQ  (  (1 << BLE_FEAT_ENC                   ) \
...
/// Features byte 1
#define BLE_FEATURES_BYTE1_AMBQ  (  (BLE_PHY_2MBPS_SUPPORT         << (BLE_FEAT_2M_PHY            - 8) ) \
                             | (1                             << (BLE_FEAT_EXT_ADV           - 8) ) \
                             | (1                             << (BLE_FEAT_PER_ADV           - 8) )) \
                             | (1                             << (BLE_FEAT_CHAN_SEL_ALGO_2   - 8) )


#define BLE_FEATURES_BYTE2_AMBQ (  (1                                      << (BLE_FEAT_MIN_NUM_USED_CHAN_PROC - 16) ) \
                             ...
                             | (/*BLE_AOD*/  0                              << (BLE_FEAT_AOD                    - 16) ) \
                             | (/*BLE_AOA */ 0                               << (BLE_FEAT_AOA                    - 16) ) \
                             | ((BLE_CON_CTE_REQ | BLE_CONLESS_CTE_RX) << (BLE_FEAT_CTE_RX                 - 16) ) )

#define BLE_FEATURES_BYTE3_AMBQ ((1 << (BLE_FEAT_PER_ADV_SYNC_TRANSF_TX - 24) ) \
...
#define BLE_NORMAL_WIN_SIZE              20 //14  //TODO ding.yuanwu
#define BLE_NORMAL_WIN_SIZE_HW           20 //14  
...
#define BLE_ACL_RX_BUF_HEADER_SPACE  (HCI_ACL_HDR_LEN + 1)  //TODO_VAR

/// Number of TX ACL data buffers
#define BLE_ACL_BUF_NB_TX            (BLE_ACTIVITY_MAX + 2)  //TODO_VAR
